...
export default {
    ...
    computed: {
        ...
        comment_data: {
            get(){
                return this.$store.state.dialog.comment_dialog.current_comments;
            }
        }
        //-------------------------------------------
    }
