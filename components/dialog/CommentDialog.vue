        ...
        >
            <v-card>
                ...
                <v-card-text style="height: 320px; padding-top: 25px;">
                    ...
                    <v-progress-linear
                        v-else-if="$route.name === 'teacher-stream'"
...
// Imported mixins
import send_comment_operation from '../../mixins/send_comment/send_comment_operation'
import send_comment_operation_request from '../../mixins/send_comment/send_comment_operation_request'
import send_comment_operation_response from '../../mixins/send_comment/send_comment_operation_response'
//------------------------------------------

export default {
    name: 'CommentDialog', // Component name
    ...
    computed: {
        ...
        comment_dialog: {
            get(){
                if (this.$store.state.dialog.comment_dialog.value === true){
                ...
                } else if (this.$store.state.dialog.comment_dialog.value === false){
                    this.comment_data = '';
                    this.can_comment = true;
                ...
                return this.$store.state.dialog.comment_dialog.value;
            },

            set(value){
                this.$store.commit('dialog/comment_dialog/update_dialog', { value: value });
            }
        },
        //-------------------------------------------

        // post id property from vuex
        current_post_id: function(){
            return this.$store.state.dialog.comment_dialog.current_post_id;
        },
        //-------------------------------------------
    ...
    methods: {
        ...
        send_comment(){
            ...
            this.send_comment_operation(this.comment_data, class_code, this.current_post_id); // Execute method
        },
        //-------------------------------
