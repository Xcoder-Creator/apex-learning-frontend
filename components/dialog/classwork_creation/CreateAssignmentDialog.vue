<template>
    <v-row justify="center">
        <v-dialog
            v-model="create_assignment_dialog"
            fullscreen
            hide-overlay
...
export default {
    name: 'CreateAssignmentDialog', // Component name
    ...
    computed: {
        ...
        create_assignment_dialog: {
            get(){
                if (this.$store.state.create_assignment_dialog.value === false){
                ...
                return this.$store.state.create_assignment_dialog.value;
            },

            set(value){
                this.$store.commit('create_assignment_dialog/update_dialog', { value: value });
            }
        },
        //--------------------------------------------
    ...
    methods: {
        ...
        assign_classwork(){
            if (this.can_assign_work === true){
                ...
                this.validate_classwork(this.title, this.instruction, this.points, this.date, this.time, full_date, this.questions_array, 'assignment', { month: this.month, day: this.day, year: this.year });
