    ...
    <div class="post_contents">
        <div id="top-head-comp">
            <div id="profile-head-data">
                <v-list-item v-if="item.post_type === 'assignment_post_with_attachment'" two-line style="padding-bottom: 5px; padding-top: 5px; text-align: left;">
                    ...
                    <v-list-item-content>
                        <v-list-item-title id="plain-comp-title">New assignment: {{ item.title }}</v-list-item-title>
...
<script>
export default {
    name: 'AssignmentPostWithAttachment', // Component name
