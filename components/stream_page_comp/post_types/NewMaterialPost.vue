    ...
    <div class="post_contents">
        <div id="top-head-comp">
            <div id="profile-head-data">
                <v-list-item v-if="item.post_type === 'new_material_post'" two-line style="padding-bottom: 5px; padding-top: 5px; text-align: left;">
                    <v-avatar size="34" id="mr" color="#2393ff">
                        <v-icon id="mr_edit_ico" style="margin-left: 1px;" dark>
                            mdi-card-text-outline
                        </v-icon>
                    </v-avatar>

                    <v-list-item-content>
                        <v-list-item-title id="plain-comp-title">New material: {{ item.title }}</v-list-item-title>
...
<script>
export default {
    name: 'NewMaterialPost', // Component name
