export default {
    methods: {
        // A Fetch request method to check if the email provided belongs to a valid account
        check_email_fetch_request(request){
            return new Promise((resolve, reject) => {
                fetch(`${ this.$config.apiUrl }/api/v1/send-reset-code`, request)
