export default {
    methods: {
        // Activity forms page mounted mixin method
                ...
                if (!('fetch' in window) || !('AbortController' in window)){
                    ...
                    if (is_logged_in === true){
                        ...
                        if (user_role === 'Student'){
                            ...
                            window.location.href = `${this.$config.teacher_classesUrl}`;
                        }
                        //-----------------------------------------------------
                        ...
                        if (environment === 'development'){
                            ...
                            if (access_token === 'TEST_TOKEN'){
                                ...
                                if (this.$store.state.user_details.user_details.details.user_role === 'Student'){
                                    window.location.href = `/student/classes/`; // Redirect user to the classes home page
                                } else if (this.$store.state.user_details.user_details.details.user_role === 'Teacher'){
                                    window.location.href = `/teacher/classes/`; // Redirect user to the classes home page
                                }
                            }
                            //----------------------------------------------------
                        }
