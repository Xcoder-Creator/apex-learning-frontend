export default {
    methods: {
        // Settings page mounted mixin method
        settings_page_mounted(){
            ...
            if (detect_ie() === true){
                ...
                if (!('fetch' in window) || !('AbortController' in window)){
                    ...
                    this.$store.commit('watch_navdrawer_items/update_value', { sect: 3, value: 1 }); // Target the settings tab on the nav drawer
                    ...
                    if (is_logged_in === true){
                        ...
                        if (this.$store.state.user_details.user_details.details.user_role === 'Student'){
                            if (this.$route.name === 'student-settings'){
                            ...
                            if (this.$route.name === 'teacher-settings'){
                                let value = this.$store.state.classes_home_page.config.value;
