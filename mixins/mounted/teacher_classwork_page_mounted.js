export default {
    methods: {
        // Teacher classwork page mounted mixin method
                            ...
                            if (class_code){
                                ...
                                if (class_array.length > 0){
                                    ...
                                    if (class_info.length > 0 && class_info.length === 1){
                                        ...
                                        let all_classworks = this.$store.state.teacher_classwork_page.classwork_comp.active_classworks;
                                        ...
                                        if (all_classworks[class_code]){
                                            if (all_classworks[class_code].length > 0){
                                                ...
                                                this.$store.commit('teacher_classwork_page/classwork_comp/update_classwork_array', { value: active_classworks });
                                                ...
                                                this.teacher_fetch_classworks(class_code); // Fetch classworks
                                            }
                                        } else {
                                            this.teacher_fetch_classworks(class_code); // Fetch classworks
                                        }
