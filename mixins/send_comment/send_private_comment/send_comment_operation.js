export default {
    methods: {
        ...
        async send_comment_operation(comment, class_code, classwork_id, student_id){
                    ...
                    if (comment.length <= 500 && comment.length !== 0){
                        ...
                        if (response.status === true){
                            ...
                            if (data_status.status === 'error'){
                                ...
                                this.can_comment = true;
                                this.comment_data = '';
                                this.$store.commit('dialog/private_comment_dialog/update_dialog', { value: false });
                                ...
                                this.$store.commit('dialog/private_comment_dialog/add_new_comment', { comment_data: comment_data });
