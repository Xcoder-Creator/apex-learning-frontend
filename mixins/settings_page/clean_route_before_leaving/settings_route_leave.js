export default {
    methods: {
        settings_route_leave(){
            ...
            this.$store.commit('dialog/upload_profile_img_dialog/reset_data'); // Reset data

            this.$store.commit('dialog/change_name_and_email_dialog/reset_data'); // Reset data

            this.$store.commit('dialog/update_password_dialog/reset_data'); // Reset data
