export default {
    methods: {
        student_classes_home_route_leave(){
            ...
            this.$store.commit('dialog/unenroll_dialog/unenroll_dialog/reset_data'); // Reset unenroll dialog data in vuex
            ...
            this.$store.commit('unenroll_from_class/reset_data'); // Reset unenroll from class from vuex

            this.$store.commit('join_class_dialog/reset_data'); // Reset join class dialog from vuex

            this.$store.commit('classes_home_page/classes_home_route_config/reset_data'); // Reset classes home route config from vuex
