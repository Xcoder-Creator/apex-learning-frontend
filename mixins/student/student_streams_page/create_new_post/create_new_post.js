export default {
    methods: {
        ...
        async create_new_post(post_data, files){
            let can_create_post = this.$store.state.student_streams_page.stream_comp.can_create_post;
                            ...
                            if (good_files === files_array_length){
                                if (this.$route.query.class_code){
                                    ...
                                    if (environment === 'development'){
                                        ...
                                        this.send_request(request, class_code, post_type, data_content);
