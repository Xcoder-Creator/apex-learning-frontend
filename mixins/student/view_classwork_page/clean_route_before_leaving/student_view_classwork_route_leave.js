    ...
    methods: {
        student_view_classwork_route_leave(){
            ...
            if (this.$store.state.user_details.user_details.is_logged_in === false){
                ...
                this.$store.commit('dialog/student_private_comment_dialog/reset_data'); // Reset comments data
                this.$store.commit('student_view_classwork_page/page_settings/reset_data'); // Reset page settings
            }
            //-----------------------------------------------------------------
