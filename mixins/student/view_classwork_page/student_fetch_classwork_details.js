export default {
    methods: {
        // Student fetch classwork details mixin method to fetch the details of a particular classwork
        async student_fetch_classwork_details(class_code, classwork_id){
