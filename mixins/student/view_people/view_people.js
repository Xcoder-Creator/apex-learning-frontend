export default {
    methods: {
        ...
        async view_people(class_code){
            ...
            this.$store.commit('student_people_page/people_comp/update_people_data_fetched', { value: false }); // People fetched property from vuex
