export default {
    methods: {
        teacher_classes_home_route_leave(){
            ...
            this.$store.commit('dialog/archive_dialog/archive_dialog/reset_data'); // Reset archive class dialog

            this.$store.commit('edit_class_dialog/reset_data'); // Reset edit class dialog
        }
    }
}