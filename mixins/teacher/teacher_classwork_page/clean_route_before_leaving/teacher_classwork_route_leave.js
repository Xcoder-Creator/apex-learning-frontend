    ...
    methods: {
        teacher_classwork_route_leave(){
            ...
            if (this.$store.state.user_details.user_details.is_logged_in === false){
                ...
                this.$store.commit('teacher_classwork_page/classwork_comp/reset_data'); // Reset teacher classwork page properties in vuex
            }
            //-----------------------------------------------------------------
            ...
            this.$store.commit('create_assignment_dialog/reset_data'); // Reset create assignment dialog

            this.$store.commit('create_classwork_dialog/reset_data'); // Reset create classwork dialog
