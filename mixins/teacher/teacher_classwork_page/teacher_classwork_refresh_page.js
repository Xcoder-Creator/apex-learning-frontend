export default {
    methods: {
        // Teacher classworks refresh page mixin method to refresh the contents of the teacher classwork page
        async teacher_classwork_refresh_page(class_code){
            ...
            let response = await this.teacher_fetch_classworks_request(request); // Await response from the backend

            // Analyze the response recieved
            if (response.status === true){
                let data_status = this.teacher_fetch_classworks_response(response.result); // Validate the response
