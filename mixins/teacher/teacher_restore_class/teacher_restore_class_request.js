export default {
    methods: {
        // A Fetch request method to restore a particular class
        teacher_restore_class_request(request){
            return new Promise((resolve, reject) => {
                fetch(`${ this.$config.apiUrl }/api/v1/teacher/restore-class`, request)
