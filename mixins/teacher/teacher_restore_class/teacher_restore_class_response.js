export default {
    methods: {
        // Check and validate the response gotten from the restore class endpoint
        teacher_restore_class_response(data){
            if (data.status === 'missing_credentials'){
                ...
                return obj;
            } else if (data.status === 'class_restored_successfully'){
