export default {
    methods: {
        // Get more available posts
        async teacher_get_more_available_posts(class_code, offset){
            ...
            this.$store.commit('teacher_streams_page/stream_comp/update_spinner', { value: true });
                            ...
                            if (active_class_posts.hasOwnProperty(class_code)){
                                if (active_offsets){
                                    if (active_offsets.hasOwnProperty(class_code)){
                                        ...
                                        this.$store.commit('teacher_streams_page/stream_comp/update_active_post_offset', { class_code: class_code, offset: data_status.offset }); // Add more posts
                                        let new_posts = [];
                                        let post_id_array = [];
                                        ...
                                        if (new_posts.length > 0){
                                            new_posts.forEach(post => {
                                                this.$store.commit('teacher_streams_page/stream_comp/add_more_posts', { class_code: class_code, class_post: post }); // Add more posts
                                            });
                                        }
                                        ...
                                        if (this.$store.state.teacher_streams_page.stream_comp.refresh_data === true){
