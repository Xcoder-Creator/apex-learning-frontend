export default {
    methods: {
        ...
        async teacher_refresh_data(){
            let refresh_data = this.$store.state.teacher_streams_page.stream_comp.refresh_data; // Refresh data property from vuex
            ...
            if (refresh_data === true){
                if (this.$route.query.class_code){
                    ...
                    if (this.$route.name === 'teacher-stream'){
                        ...
                        this.$store.commit('teacher_streams_page/stream_comp/remove_upcoming_work_data', { class_code: class_code }); // Remove upcoming work data from vuex
                        ...
                        this.$store.commit('dialog/private_comment_dialog/reset_data');
                    }

                    if (this.$route.name === 'teacher-people'){
                        this.teacher_people_refresh_page(class_code); // Refresh teacher people page
                    } else if (this.$route.name === 'teacher-classwork'){
                        this.teacher_classwork_refresh_page(class_code); // Refresh teacher classwork page
                    } else if (this.$route.name === 'teacher-view_classwork'){
                        if (this.$route.query.id){
                            this.teacher_view_classwork_refresh_page(class_code, this.$route.query.id);
                        } else {
