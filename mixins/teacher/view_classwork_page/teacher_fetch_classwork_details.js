export default {
    methods: {
        // Teacher fetch classwork details mixin method to fetch the details of a particular classwork
        async teacher_fetch_classwork_details(class_code, classwork_id){
