...
import student_classes_page_mounted from '../../mixins/mounted/student_classes_page_mounted'
...
export default {
    ...
    head: {
        ...
        title: 'Student Classes | Apex-Learning',

        meta: [
            { charset: 'utf-8' },
            { name: 'viewport', content: 'width=device-width, initial-scale=1' },
            { name: 'viewport', content: 'width=device-width, initial-scale=1, shrink-to-fit=no' },
            { name: 'keywords', content: 'Classes page, Student section , Student classes' },
            { hid: 'description', name: 'description', content: 'View all of your classes and access them' },
    ...
    mounted(){
        this.$nextTick(async () => {
            ...
            this.student_classes_page_mounted(); // Student classes page mounted mixin method
        });
    },
    //-------------------------------------------
    ...
    beforeRouteLeave(to, from, next){
        ...
        setTimeout(() => {
            this.student_classes_home_route_leave(); // Route leave method
        }, 30);
