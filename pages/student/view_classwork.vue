...
import ClassworkList from '../../components/student_view_classwork_page/ClassworkList'
import StudentPrivateCommentDialog from '../../components/dialog/StudentPrivateCommentDialog'
...
import student_view_classwork_page_mounted from '../../mixins/mounted/student_view_classwork_page_mounted'
...
export default {
    ...
    mixins: [
        ...
        student_view_classwork_page_mounted,
    ...
    head(){
        return {
            ...
            meta: [
                ...
                { name: 'keywords', content: 'View classwork, Student section' },
                { name: 'description', content: 'View a particular classwork for a class' },
    ...
    computed: {
        ...
        classwork_details_fetched: function(){
            return this.$store.state.student_view_classwork_page.classwork_details_comp.classwork_details_fetched;
        },
        //-----------------------------------------------
    ...
    mounted(){
        this.$nextTick(() => {
            ...
            this.student_view_classwork_page_mounted(); // Student view classwork page mounted mixin method
        });
    },
    //-------------------------------------------
