...
import teacher_people_page_mounted from '../../mixins/mounted/teacher_people_page_mounted'
...
import teacher_view_peoplen_response from '../../mixins/teacher/view_people/teacher_view_people_response'
...
export default {
    ...
    head(){
        return {
            ...
            meta: [
                ...
                { name: 'keywords', content: 'People page, Teacher section' },
    ...
    computed: {
        ...
        people_data_fetched: function(){
            return this.$store.state.teacher_people_page.people_comp.people_data_fetched;
        },
        //-----------------------------------------------
    ...
    mounted(){
        this.$nextTick(() => {
            ...
            this.teacher_people_page_mounted();
        });
    },
    //-------------------------------------------
    ...
    beforeRouteLeave(to, from, next){
        ...
        setTimeout(() => {
            this.teacher_people_route_leave(); // Route leave method
        }, 30);
